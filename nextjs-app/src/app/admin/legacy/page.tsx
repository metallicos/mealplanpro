...
import {
    ...
    ChevronLeft, ChevronRight, Plus, ArrowLeft
} from 'lucide-react';
        ...
        <div className="animate-fade-in">
            ...
            <div className="mb-8">
                ...
                <h1 className="page-title flex flex-wrap items-center gap-2 text-2xl sm:text-3xl mb-2">
                    Data Management <Settings size={24} className="text-violet-400" />
                </h1>
                <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
                    <p className="page-subtitle text-sm sm:text-base text-gray-400">Manage users, contacts, newsletter, and content</p>
                </div>
            </div>
