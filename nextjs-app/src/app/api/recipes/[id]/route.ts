    ...
    try {
        ...
        const recipes = await query(`
            SELECT r.*, 
                   ...
                   COALESCE(NULLIF(rt.ingredients_json, ''), NULLIF(rt_en.ingredients_json, ''), '[]') as ingredients_json,
                   COALESCE(NULLIF(rt.method_json, ''), NULLIF(rt_en.method_json, ''), '[]') as method_json
            FROM recipes r
